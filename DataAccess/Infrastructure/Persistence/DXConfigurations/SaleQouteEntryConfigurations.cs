...
public class SaleQouteEntryConfiguration : IEntityTypeConfiguration<SaleQouteEntry>
{
    public void Configure(EntityTypeBuilder<SaleQouteEntry> builder)
    {
        builder.ToTable("SaleQoute_Entry");
