...
public class SaleConfirmConfiguration : IEntityTypeConfiguration<SaleConfirm>
{
    public void Configure(EntityTypeBuilder<SaleConfirm> builder)
    {
        builder.ToTable("SaleConfirm");
