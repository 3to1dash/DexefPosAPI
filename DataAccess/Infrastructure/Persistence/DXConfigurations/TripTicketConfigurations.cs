...
public class TripTicketConfiguration : IEntityTypeConfiguration<TripTicket>
{
    public void Configure(EntityTypeBuilder<TripTicket> builder)
    {
        ...
        builder.HasIndex(e => new {e.BranchId, e.CustId, e.CustPeriodId},
            "IX_Trip_Ticket_BranchID_CustID_CustPeriodID_8E177");

        builder.HasIndex(e => new {e.BranchId, e.CustId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_CustID_IssueDate_AEF83");

        builder.HasIndex(e => new {e.BranchId, e.CustId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_CustID_IssueDate_E115B");
        ...
        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_GDS_IssueDate_135A2");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_GDS_IssueDate_324A6");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_GDS_IssueDate_6D26D");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_GDS_IssueDate_E3A60");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_GDS_IssueDate_EA0B5");
        ...
        builder.HasIndex(e => new {e.BranchId, e.IssueDate, e.Passenger},
            "IX_Trip_Ticket_BranchID_IssueDate_Passenger_CE599");

        builder.HasIndex(e => new {e.BranchId, e.IssueDate, e.Passenger},
            "IX_Trip_Ticket_BranchID_IssueDate_Passenger_EA143");
        ...
        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_DT_IssueDate_BFD3E");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_DT_IssueDate_C456A");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_DT_IssueDate_CF5E6");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_DT_IssueDate_D0259");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_DT_IssueDate_D2672");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.TripGdsId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_GDS_IssueDate_01C6C");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.TripGdsId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_GDS_IssueDate_50A4E");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_IssueDate_0B08B");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_IssueDate_2337E");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_IssueDate_4B09F");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_IssueDate_DA226");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_IssueDate_EAAF9");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.IssueDate},
            "IX_Trip_Ticket_BranchID_Status_IssueDate_F6A96");

        builder.HasIndex(e => new {e.BranchId, e.TicketNumber, e.IssueDate},
            "IX_Trip_Ticket_BranchID_TicketNumber_IssueDate_696FF");

        builder.HasIndex(e => new {e.BranchId, e.TicketNumber, e.IssueDate, e.Pnr},
            "IX_Trip_Ticket_BranchID_TicketNumber_IssueDate_PNR_2734B");

        builder.HasIndex(e => new {e.BranchId, e.TicketNumber, e.IssueDate, e.Passenger},
            "IX_Trip_Ticket_BranchID_TicketNumber_IssueDate_Passenger_68599");
        ...
        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_3DC78");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_80143");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_F155B");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_F76BE");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate, e.Pnr},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_PNR_3D69F");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate, e.Pnr},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_PNR_9771A");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate, e.Pnr},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_PNR_FF420");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.IssueDate, e.Status},
            "IX_Trip_Ticket_BranchID_VendorID_IssueDate_Status_B405B");

        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.VendorPeriodId},
            "IX_Trip_Ticket_BranchID_VendorID_VendorPeriodID_B0FAB");
