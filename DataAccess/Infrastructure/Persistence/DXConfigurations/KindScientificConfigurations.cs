...
public class KindScientificConfiguration : IEntityTypeConfiguration<KindScientific>
{
    public void Configure(EntityTypeBuilder<KindScientific> builder)
    {
        builder.ToTable("Kind_Scientific");
