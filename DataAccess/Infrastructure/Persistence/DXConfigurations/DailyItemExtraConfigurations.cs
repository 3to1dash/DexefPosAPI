...
public class DailyItemExtraConfiguration : IEntityTypeConfiguration<DailyItemExtra>
{


    public void Configure(EntityTypeBuilder<DailyItemExtra> builder)
    {
        builder.ToTable("DailyItemExtra");
