...
public class PosHallEntryConfiguration : IEntityTypeConfiguration<PosHallEntry>
{
    public void Configure(EntityTypeBuilder<PosHallEntry> builder)
    {
        builder.ToTable("PosHall_Entry");
