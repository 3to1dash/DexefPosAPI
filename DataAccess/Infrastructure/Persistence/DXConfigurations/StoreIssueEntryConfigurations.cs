...
public class StoreIssueEntryConfiguration : IEntityTypeConfiguration<StoreIssueEntry>
{


    public void Configure(EntityTypeBuilder<StoreIssueEntry> builder)
    {
        builder.ToTable("StoreIssue_Entry");
