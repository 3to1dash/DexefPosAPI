...
public class ContCashpaidConfiguration : IEntityTypeConfiguration<ContCashpaid>
{


    public void Configure(EntityTypeBuilder<ContCashpaid> builder)
    {
        builder.HasNoKey();

        builder.ToTable("cont_cashpaid");
