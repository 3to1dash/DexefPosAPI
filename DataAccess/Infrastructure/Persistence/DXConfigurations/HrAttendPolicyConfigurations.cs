...
public class HrAttendPolicyConfiguration : IEntityTypeConfiguration<HrAttendPolicy>
{
    public void Configure(EntityTypeBuilder<HrAttendPolicy> builder)
    {
        builder.ToTable("Hr_AttendPolicy");
