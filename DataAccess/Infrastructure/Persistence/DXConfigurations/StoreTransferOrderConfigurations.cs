...
public class StoreTransferOrderConfiguration : IEntityTypeConfiguration<StoreTransferOrder>
{


    public void Configure(EntityTypeBuilder<StoreTransferOrder> builder)
    {
        builder.ToTable("StoreTransferOrder");
