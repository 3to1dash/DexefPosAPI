...
public class StoreSendOrderEntryConfiguration : IEntityTypeConfiguration<StoreSendOrderEntry>
{


    public void Configure(EntityTypeBuilder<StoreSendOrderEntry> builder)
    {
        builder.ToTable("StoreSendOrder_Entry");
