...
public class ShPurchaseConfiguration : IEntityTypeConfiguration<ShPurchase>
{


    public void Configure(EntityTypeBuilder<ShPurchase> builder)
    {
        builder.ToTable("Sh_Purchase");
