...
public class PurchaseConfirmConfiguration : IEntityTypeConfiguration<PurchaseConfirm>
{
    public void Configure(EntityTypeBuilder<PurchaseConfirm> builder)
    {
        builder.ToTable("PurchaseConfirm");
