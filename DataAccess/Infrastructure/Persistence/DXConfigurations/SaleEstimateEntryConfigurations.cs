...
public class SaleEstimateEntryConfiguration : IEntityTypeConfiguration<SaleEstimateEntry>
{


    public void Configure(EntityTypeBuilder<SaleEstimateEntry> builder)
    {
        builder.ToTable("SaleEstimate_Entry");
