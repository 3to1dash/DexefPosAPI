...
public class KindCreatorConfiguration : IEntityTypeConfiguration<KindCreator>
{


    public void Configure(EntityTypeBuilder<KindCreator> builder)
    {
        builder.ToTable("Kind_Creator");
