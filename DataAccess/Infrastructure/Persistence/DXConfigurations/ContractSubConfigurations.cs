...
public class ContractSubConfiguration : IEntityTypeConfiguration<ContractSub>
{


    public void Configure(EntityTypeBuilder<ContractSub> builder)
    {
        builder.HasNoKey();

        builder.ToTable("contract_sub");
