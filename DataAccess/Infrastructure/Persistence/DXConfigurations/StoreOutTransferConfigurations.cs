...
public class StoreOutTransferConfiguration : IEntityTypeConfiguration<StoreOutTransfer>
{
    public void Configure(EntityTypeBuilder<StoreOutTransfer> builder)
    {
        builder.ToTable("StoreOutTransfer");
