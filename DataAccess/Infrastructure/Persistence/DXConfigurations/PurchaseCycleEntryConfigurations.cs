...
public class PurchaseCycleEntryConfiguration : IEntityTypeConfiguration<PurchaseCycleEntry>
{
    public void Configure(EntityTypeBuilder<PurchaseCycleEntry> builder)
    {
        builder.ToTable("PurchaseCycle_Entry");
