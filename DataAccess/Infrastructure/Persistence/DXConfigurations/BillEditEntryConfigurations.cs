...
public class BillEditEntryConfiguration : IEntityTypeConfiguration<BillEditEntry>
{


    public void Configure(EntityTypeBuilder<BillEditEntry> builder)
    {
        builder.HasNoKey();

        builder.ToTable("Bill_EditEntry");
