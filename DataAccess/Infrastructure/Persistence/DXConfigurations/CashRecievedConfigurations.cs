...
public class CashRecievedConfiguration : IEntityTypeConfiguration<CashRecieved>
{
    public void Configure(EntityTypeBuilder<CashRecieved> builder)
    {
        ...
        builder.HasIndex(e => new {e.BranchId, e.Updated, e.DeletedBy, e.Dt},
            "IX_Cash_Recieved_BranchID_Updated_DeletedBy_Dt_1CFDD");

        builder.HasIndex(e => new {e.BranchId, e.Updated, e.DeletedBy, e.Dt},
            "IX_Cash_Recieved_BranchID_Updated_DeletedBy_Dt_C7392");
        ...
        builder.HasIndex(e => new {e.Dafter, e.BranchId, e.Deleted, e.Updated},
            "IX_Cash_Recieved_Dafter_BranchID_Deleted_Updated_8EC3B");
