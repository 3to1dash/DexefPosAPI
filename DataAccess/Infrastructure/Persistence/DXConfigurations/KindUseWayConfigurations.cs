...
public class KindUseWayConfiguration : IEntityTypeConfiguration<KindUseWay>
{
    public void Configure(EntityTypeBuilder<KindUseWay> builder)
    {
        builder.ToTable("Kind_UseWay");
