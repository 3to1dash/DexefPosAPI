...
public class WorkExtradayConfiguration : IEntityTypeConfiguration<WorkExtraday>
{


    public void Configure(EntityTypeBuilder<WorkExtraday> builder)
    {
        builder.ToTable("work_extraday");
