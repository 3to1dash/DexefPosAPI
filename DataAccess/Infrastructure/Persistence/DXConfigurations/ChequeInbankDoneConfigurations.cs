...
public class ChequeInbankDoneConfiguration : IEntityTypeConfiguration<ChequeInbankDone>
{
    public void Configure(EntityTypeBuilder<ChequeInbankDone> builder)
    {
        builder.ToTable("Cheque_INBankDone");
