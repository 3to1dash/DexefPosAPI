...
public class ChequeInbankConfiguration : IEntityTypeConfiguration<ChequeInbank>
{
    public void Configure(EntityTypeBuilder<ChequeInbank> builder)
    {
        builder.ToTable("Cheque_INBank");
