...
public class ChequeOutDoneConfiguration : IEntityTypeConfiguration<ChequeOutDone>
{
    public void Configure(EntityTypeBuilder<ChequeOutDone> builder)
    {
        builder.ToTable("Cheque_OutDone");
