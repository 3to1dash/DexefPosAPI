...
public class SaleConfirmEntryConfiguration : IEntityTypeConfiguration<SaleConfirmEntry>
{


    public void Configure(EntityTypeBuilder<SaleConfirmEntry> builder)
    {
        builder.ToTable("SaleConfirm_Entry");
