...
public class ChequeIncustReturnConfiguration : IEntityTypeConfiguration<ChequeIncustReturn>
{
    public void Configure(EntityTypeBuilder<ChequeIncustReturn> builder)
    {
        builder.ToTable("Cheque_INCustReturn");
