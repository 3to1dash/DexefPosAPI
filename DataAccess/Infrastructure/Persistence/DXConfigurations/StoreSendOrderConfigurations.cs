...
public class StoreSendOrderConfiguration : IEntityTypeConfiguration<StoreSendOrder>
{
    public void Configure(EntityTypeBuilder<StoreSendOrder> builder)
    {
        builder.ToTable("StoreSendOrder");
