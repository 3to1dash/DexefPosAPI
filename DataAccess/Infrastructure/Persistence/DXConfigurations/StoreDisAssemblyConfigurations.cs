...
public class StoreDisAssemblyConfiguration : IEntityTypeConfiguration<StoreDisAssembly>
{


    public void Configure(EntityTypeBuilder<StoreDisAssembly> builder)
    {
        builder.ToTable("StoreDisAssembly");
        ...
        builder.Property(e => e.FromBranchId).HasColumnName("FromBranchID");

        builder.Property(e => e.FromItemId).HasColumnName("FromItemID");

        builder.Property(e => e.FromKindId).HasColumnName("FromKindID");

        builder.Property(e => e.FromQty).HasColumnType("numeric(19, 5)");

        builder.Property(e => e.FromStoreId).HasColumnName("FromStoreID");

        builder.Property(e => e.FromTotalCost).HasColumnType("numeric(19, 5)");

        builder.Property(e => e.FromUnite).HasMaxLength(50);

        builder.Property(e => e.FromUniteCost).HasColumnType("numeric(19, 5)");

        builder.Property(e => e.FromUnitePerQty).HasColumnType("numeric(19, 5)");
