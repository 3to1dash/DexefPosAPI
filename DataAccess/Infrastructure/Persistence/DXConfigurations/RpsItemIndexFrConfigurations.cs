...
public class RpsItemIndexFrConfiguration : IEntityTypeConfiguration<RpsItemIndexFr>
{


    public void Configure(EntityTypeBuilder<RpsItemIndexFr> builder)
    {
        builder.HasNoKey();

        builder.ToView("RpsItemIndexFr");
