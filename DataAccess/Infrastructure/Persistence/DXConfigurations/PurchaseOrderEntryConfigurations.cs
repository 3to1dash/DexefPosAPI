...
public class PurchaseOrderEntryConfiguration : IEntityTypeConfiguration<PurchaseOrderEntry>
{


    public void Configure(EntityTypeBuilder<PurchaseOrderEntry> builder)
    {
        builder.ToTable("PurchaseOrder_Entry");
