...
public class StorePackingConfiguration : IEntityTypeConfiguration<StorePacking>
{


    public void Configure(EntityTypeBuilder<StorePacking> builder)
    {
        builder.ToTable("StorePacking");
