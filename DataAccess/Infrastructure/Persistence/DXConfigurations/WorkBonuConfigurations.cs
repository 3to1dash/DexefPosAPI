...
public class WorkBonuConfiguration : IEntityTypeConfiguration<WorkBonu>
{
    public void Configure(EntityTypeBuilder<WorkBonu> builder)
    {
        builder.ToTable("Work_Bonus");
