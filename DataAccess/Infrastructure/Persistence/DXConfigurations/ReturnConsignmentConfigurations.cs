...
public class ReturnConsignmentConfiguration : IEntityTypeConfiguration<ReturnConsignment>
{
    public void Configure(EntityTypeBuilder<ReturnConsignment> builder)
    {
        builder.ToTable("ReturnConsignment");
