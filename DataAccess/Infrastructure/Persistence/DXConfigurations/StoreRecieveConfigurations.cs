...
public class StoreRecieveConfiguration : IEntityTypeConfiguration<StoreRecieve>
{


    public void Configure(EntityTypeBuilder<StoreRecieve> builder)
    {
        builder.ToTable("StoreRecieve");
