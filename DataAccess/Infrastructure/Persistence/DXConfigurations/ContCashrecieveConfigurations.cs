...
public class ContCashrecieveConfiguration : IEntityTypeConfiguration<ContCashrecieve>
{


    public void Configure(EntityTypeBuilder<ContCashrecieve> builder)
    {
        builder.HasNoKey();

        builder.ToTable("cont_cashrecieve");
