...
public class TripTicketTempConfiguration : IEntityTypeConfiguration<TripTicketTemp>
{
    public void Configure(EntityTypeBuilder<TripTicketTemp> builder)
    {
        ...
        builder.HasIndex(e => new {e.BranchId, e.CustId, e.Dt, e.Status},
            "IX_Trip_TicketTemp_BranchID_CustID_DT_Status_E6BC6");
        ...
        builder.HasIndex(e => new {e.BranchId, e.Dt, e.AirLineVendorComm},
            "IX_Trip_TicketTemp_BranchID_DT_AirLineVendorComm_5FBB9");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.AirLineVendorComm},
            "IX_Trip_TicketTemp_BranchID_DT_AirLineVendorComm_AB81F");
        ...
        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.OfficeId},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_OfficeID_548A3");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.OfficeId},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_OfficeID_B991B");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_20FAD");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_33F7B");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_3850C");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_71751");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_74464");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_80B32");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_8EFE5");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_9E820");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_A1132");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_C733E");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_PNR_ED99D");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Passenger},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Passenger_0C84C");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_03DE7");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_3A638");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_4E262");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_5AD40");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_5BF1F");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_796FC");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_A3B64");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_AD2D9");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_C16FE");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_D8846");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_PNR_0D805");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_PNR_170CC");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.IssueDate, e.Status, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_DT_IssueDate_Status_PNR_94250");
        ...
        builder.HasIndex(e => new {e.BranchId, e.Dt, e.Status, e.VendorId, e.CustId},
            "IX_Trip_TicketTemp_BranchID_DT_Status_VendorID_CustID_53CF5");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.Status, e.VendorId, e.CustId},
            "IX_Trip_TicketTemp_BranchID_DT_Status_VendorID_CustID_7CEBE");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.Status, e.VendorId, e.CustId},
            "IX_Trip_TicketTemp_BranchID_DT_Status_VendorID_CustID_B23FD");

        builder.HasIndex(e => new {e.BranchId, e.Dt, e.Status, e.VendorId, e.CustId},
            "IX_Trip_TicketTemp_BranchID_DT_Status_VendorID_CustID_FC279");

        builder.HasIndex(e => new {e.BranchId, e.OfficeId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_OfficeID_DT_IssueDate_Status_1F401");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Commision, e.Dt},
            "IX_Trip_TicketTemp_BranchID_Status_Commision_DT_02D87");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Commision, e.Dt},
            "IX_Trip_TicketTemp_BranchID_Status_Commision_DT_2E651");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Commision, e.Dt},
            "IX_Trip_TicketTemp_BranchID_Status_Commision_DT_9665C");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Commision, e.Dt, e.Pnr},
            "IX_Trip_TicketTemp_BranchID_Status_Commision_DT_PNR_15C6F");
        ...
        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_0DB2E");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_0F6B4");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_14FBC");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_2C5A3");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_2D1F6");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_384AA");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_64A27");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_64FBB");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_6AD8E");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_98780");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_A7D22");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_BD58C");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_E4181");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Status_DT_IssueDate_EA2D4");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.NetTotal},
            "IX_Trip_TicketTemp_BranchID_Status_DT_NetTotal_5A90F");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.NetTotal},
            "IX_Trip_TicketTemp_BranchID_Status_DT_NetTotal_7A2ED");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.Dt, e.NetTotal},
            "IX_Trip_TicketTemp_BranchID_Status_DT_NetTotal_EDC38");

        builder.HasIndex(e => new {e.BranchId, e.Status, e.VendorCost, e.Dt},
            "IX_Trip_TicketTemp_BranchID_Status_VendorCost_DT_C7689");

        builder.HasIndex(e => new {e.BranchId, e.TicketNumber, e.Dt},
            "IX_Trip_TicketTemp_BranchID_TicketNumber_DT_C6367");
        ...
        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_21CFD");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_228C0");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_2F28B");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_42548");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_560C2");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_7E427");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_883A6");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_926C6");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_D14F5");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_2B801");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_56DD1");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_687D2");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_68EC3");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_935E3");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_A475E");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_C2D3F");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_E15D2");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_E2497");

        builder.HasIndex(e => new {e.BranchId, e.TripGdsId, e.Dt, e.IssueDate, e.Status},
            "IX_Trip_TicketTemp_BranchID_Trip_GdsId_DT_IssueDate_Status_E7377");
        ...
        builder.HasIndex(e => new {e.BranchId, e.VendorId, e.Dt, e.Status},
            "IX_Trip_TicketTemp_BranchID_VendorID_DT_Status_2F7DE");

        builder.HasIndex(e => e.CustId, "IX_Trip_TicketTemp_CustID_7F27B");

        builder.HasIndex(e => e.Pnr, "IX_Trip_TicketTemp_PNR_06CD3");

        builder.HasIndex(e => new {e.TicketNumber, e.Status, e.VendorId},
            "IX_Trip_TicketTemp_TicketNumber_Status_VendorID_D95C2");
