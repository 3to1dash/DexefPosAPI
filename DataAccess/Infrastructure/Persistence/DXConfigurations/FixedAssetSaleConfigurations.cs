...
public class FixedAssetSaleConfiguration : IEntityTypeConfiguration<FixedAssetSale>
{
    public void Configure(EntityTypeBuilder<FixedAssetSale> builder)
    {
        builder.ToTable("FixedAssetSale");
