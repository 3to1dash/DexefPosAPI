...
public class StoreInTransferConfiguration : IEntityTypeConfiguration<StoreInTransfer>
{
    public void Configure(EntityTypeBuilder<StoreInTransfer> builder)
    {
        builder.ToTable("StoreInTransfer");
