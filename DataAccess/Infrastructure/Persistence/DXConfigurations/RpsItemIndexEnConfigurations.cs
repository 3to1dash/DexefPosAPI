...
public class RpsItemIndexEnConfiguration : IEntityTypeConfiguration<RpsItemIndexEn>
{
    public void Configure(EntityTypeBuilder<RpsItemIndexEn> builder)
    {
        builder.HasNoKey();

        builder.ToView("RpsItemIndexEN");
