...
public class WorkPledgePayFileConfigurations : IEntityTypeConfiguration<WorkPledgePayFile>
{
    public void Configure(EntityTypeBuilder<WorkPledgePayFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_Work_PledgePay_Files_1");

        builder.ToTable("Work_PledgePay_Files");
