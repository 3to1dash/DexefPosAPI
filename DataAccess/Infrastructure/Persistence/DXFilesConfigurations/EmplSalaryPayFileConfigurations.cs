...
public class EmplSalaryPayFileConfigurations : IEntityTypeConfiguration<EmplSalaryPayFile>
{
    public void Configure(EntityTypeBuilder<EmplSalaryPayFile> builder)
    {
        builder.ToTable("Empl_SalaryPay_Files");
