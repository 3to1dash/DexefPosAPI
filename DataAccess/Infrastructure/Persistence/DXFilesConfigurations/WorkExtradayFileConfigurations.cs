...
public class WorkExtradayFileConfigurations : IEntityTypeConfiguration<WorkExtradayFile>
{
    public void Configure(EntityTypeBuilder<WorkExtradayFile> builder)
    {
        builder.ToTable("work_extraday_Files");
