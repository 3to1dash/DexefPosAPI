...
public class ItemsFileConfigurations : IEntityTypeConfiguration<ItemsFile>
{
    public void Configure(EntityTypeBuilder<ItemsFile> builder)
    {
        builder.ToTable("Items_Files");
