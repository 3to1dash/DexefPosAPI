...
public class AccountsFileConfigurations : IEntityTypeConfiguration<AccountsFile>
{
    public void Configure(EntityTypeBuilder<AccountsFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_Accounts_Files_1");

        builder.ToTable("Accounts_Files");
