...
public class InvoiceGroupConfigurations : IEntityTypeConfiguration<InvoiceGroup>
{
    public void Configure(EntityTypeBuilder<InvoiceGroup> builder)
    {
        builder.ToTable("Invoice_Groups");
