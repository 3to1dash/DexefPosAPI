...
public class ChequeFileConfigurations : IEntityTypeConfiguration<ChequeFile>
{
    public void Configure(EntityTypeBuilder<ChequeFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_Cheque_Files_1");

        builder.ToTable("Cheque_Files");
