...
public class EmplTransactionFileConfigurations : IEntityTypeConfiguration<EmplTransactionFile>
{
    public void Configure(EntityTypeBuilder<EmplTransactionFile> builder)
    {
        builder.ToTable("Empl_Transaction_Files");
