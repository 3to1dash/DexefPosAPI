...
public class ExpensesFileConfigurations : IEntityTypeConfiguration<ExpensesFile>
{
    public void Configure(EntityTypeBuilder<ExpensesFile> builder)
    {
        builder.ToTable("Expenses_Files");
