...
public class FixedAssetAreaFileConfigurations : IEntityTypeConfiguration<FixedAssetAreaFile>
{
    public void Configure(EntityTypeBuilder<FixedAssetAreaFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_FixedAssetArea_Files_1");

        builder.ToTable("FixedAssetArea_Files");
