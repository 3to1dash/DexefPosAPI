...
public class TripContractFileConfigurations : IEntityTypeConfiguration<TripContractFile>
{
    public void Configure(EntityTypeBuilder<TripContractFile> builder)
    {
        builder.ToTable("Trip_Contract_Files");
