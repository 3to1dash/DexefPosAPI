...
public class EmplSalaryCalcFileConfigurations : IEntityTypeConfiguration<EmplSalaryCalcFile>
{
    public void Configure(EntityTypeBuilder<EmplSalaryCalcFile> builder)
    {
        builder.ToTable("Empl_SalaryCalc_Files");
