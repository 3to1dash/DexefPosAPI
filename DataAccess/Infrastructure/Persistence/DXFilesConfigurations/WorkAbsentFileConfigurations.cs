...
public class WorkAbsentFileConfigurations : IEntityTypeConfiguration<WorkAbsentFile>
{
    public void Configure(EntityTypeBuilder<WorkAbsentFile> builder)
    {
        builder.ToTable("Work_Absent_Files");
