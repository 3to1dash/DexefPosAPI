...
public class CashPaymentFileConfigurations : IEntityTypeConfiguration<CashPaymentFile>
{
    public void Configure(EntityTypeBuilder<CashPaymentFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_CashPayment_Files_1");

        builder.ToTable("CashPayment_Files");
