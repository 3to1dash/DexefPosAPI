...
public class FixedAssetFileConfigurations : IEntityTypeConfiguration<FixedAssetFile>
{
    public void Configure(EntityTypeBuilder<FixedAssetFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_FixedAsset_Files_1");

        builder.ToTable("FixedAsset_Files");
