...
public class ChequeGroupConfigurations : IEntityTypeConfiguration<ChequeGroup>
{
    public void Configure(EntityTypeBuilder<ChequeGroup> builder)
    {
        builder.ToTable("Cheque_Groups");
