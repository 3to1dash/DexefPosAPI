...
public class WorkPledgePayGroupConfigurations : IEntityTypeConfiguration<WorkPledgePayGroup>
{
    public void Configure(EntityTypeBuilder<WorkPledgePayGroup> builder)
    {
        builder.ToTable("Work_PledgePay_Groups");
