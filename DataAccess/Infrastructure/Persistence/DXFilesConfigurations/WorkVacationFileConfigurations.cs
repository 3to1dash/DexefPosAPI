...
public class WorkVacationFileConfigurations : IEntityTypeConfiguration<WorkVacationFile>
{
    public void Configure(EntityTypeBuilder<WorkVacationFile> builder)
    {
        builder.ToTable("Work_Vacation_Files");
