...
public class TripTicketFileConfigurations : IEntityTypeConfiguration<TripTicketFile>
{
    public void Configure(EntityTypeBuilder<TripTicketFile> builder)
    {
        builder.ToTable("TripTicket_Files");
