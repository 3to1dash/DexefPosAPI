...
public class WorkVacationGroupConfigurations : IEntityTypeConfiguration<WorkVacationGroup>
{
    public void Configure(EntityTypeBuilder<WorkVacationGroup> builder)
    {
        builder.ToTable("Work_Vacation_Groups");
