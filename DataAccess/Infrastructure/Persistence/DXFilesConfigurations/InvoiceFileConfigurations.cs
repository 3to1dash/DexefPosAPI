...
public class InvoiceFileConfigurations : IEntityTypeConfiguration<InvoiceFile>
{
    public void Configure(EntityTypeBuilder<InvoiceFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_Invoice_Files_1");

        builder.ToTable("Invoice_Files");
