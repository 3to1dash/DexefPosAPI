...
public class WorkPermissionFileConfigurations : IEntityTypeConfiguration<WorkPermissionFile>
{
    public void Configure(EntityTypeBuilder<WorkPermissionFile> builder)
    {
        builder.ToTable("Work_Permission_Files");
