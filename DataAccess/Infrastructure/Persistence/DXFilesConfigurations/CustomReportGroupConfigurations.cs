...
public class CustomReportGroupConfigurations : IEntityTypeConfiguration<CustomReportGroup>
{
    public void Configure(EntityTypeBuilder<CustomReportGroup> builder)
    {
        builder.ToTable("CustomReport_Groups");
