...
public class FixedAssetCategoryFileConfigurations : IEntityTypeConfiguration<FixedAssetCategoryFile>
{
    public void Configure(EntityTypeBuilder<FixedAssetCategoryFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_FixedAssetCategory_Files_1");

        builder.ToTable("FixedAssetCategory_Files");
