...
public class CashPaymentGroupConfigurations : IEntityTypeConfiguration<CashPaymentGroup>
{
    public void Configure(EntityTypeBuilder<CashPaymentGroup> builder)
    {
        builder.ToTable("CashPayment_Groups");
