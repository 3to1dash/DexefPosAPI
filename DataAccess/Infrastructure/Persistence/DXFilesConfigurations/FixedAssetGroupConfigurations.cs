...
public class FixedAssetGroupConfigurations : IEntityTypeConfiguration<FixedAssetGroup>
{
    public void Configure(EntityTypeBuilder<FixedAssetGroup> builder)
    {
        builder.ToTable("FixedAsset_Groups");
