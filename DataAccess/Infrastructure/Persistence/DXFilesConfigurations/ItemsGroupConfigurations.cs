...
public class ItemsGroupConfigurations : IEntityTypeConfiguration<ItemsGroup>
{
    public void Configure(EntityTypeBuilder<ItemsGroup> builder)
    {
        builder.ToTable("Items_Groups");
