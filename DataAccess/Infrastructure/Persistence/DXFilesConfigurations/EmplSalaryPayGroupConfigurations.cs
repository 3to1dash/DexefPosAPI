...
public class EmplSalaryPayGroupConfigurations : IEntityTypeConfiguration<EmplSalaryPayGroup>
{
    public void Configure(EntityTypeBuilder<EmplSalaryPayGroup> builder)
    {
        builder.ToTable("Empl_SalaryPay_Groups");
