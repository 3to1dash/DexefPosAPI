...
internal class WorkAbsentGroupConfigurations : IEntityTypeConfiguration<WorkAbsentGroup>
{
    public void Configure(EntityTypeBuilder<WorkAbsentGroup> builder)
    {
        builder.ToTable("Work_Absent_Groups");
