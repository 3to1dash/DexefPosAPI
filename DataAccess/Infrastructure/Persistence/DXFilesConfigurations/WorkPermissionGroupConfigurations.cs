...
public class WorkPermissionGroupConfigurations : IEntityTypeConfiguration<WorkPermissionGroup>
{
    public void Configure(EntityTypeBuilder<WorkPermissionGroup> builder)
    {
        builder.ToTable("Work_Permission_Groups");
