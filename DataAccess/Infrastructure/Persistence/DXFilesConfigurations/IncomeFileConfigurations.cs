...
public class IncomeFileConfigurations : IEntityTypeConfiguration<IncomeFile>
{
    public void Configure(EntityTypeBuilder<IncomeFile> builder)
    {
        builder.ToTable("Income_Files");
