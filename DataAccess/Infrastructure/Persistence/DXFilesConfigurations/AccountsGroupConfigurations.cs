...
public class AccountsGroupConfigurations : IEntityTypeConfiguration<AccountsGroup>
{
    public void Configure(EntityTypeBuilder<AccountsGroup> builder)
    {
        builder.ToTable("Accounts_Groups");
