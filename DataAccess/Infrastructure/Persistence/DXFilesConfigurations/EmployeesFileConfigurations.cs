...
public class EmployeesFileConfigurations : IEntityTypeConfiguration<EmployeesFile>
{
    public void Configure(EntityTypeBuilder<EmployeesFile> builder)
    {
        builder.ToTable("Employees_Files");
