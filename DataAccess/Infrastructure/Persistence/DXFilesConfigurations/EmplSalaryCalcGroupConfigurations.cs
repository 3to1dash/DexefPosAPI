...
public class EmplSalaryCalcGroupConfigurations : IEntityTypeConfiguration<EmplSalaryCalcGroup>
{
    public void Configure(EntityTypeBuilder<EmplSalaryCalcGroup> builder)
    {
        builder.ToTable("Empl_SalaryCalc_Groups");
