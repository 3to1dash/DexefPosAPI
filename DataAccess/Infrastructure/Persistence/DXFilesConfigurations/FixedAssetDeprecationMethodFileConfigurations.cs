...
public class FixedAssetDeprecationMethodFileConfigurations : IEntityTypeConfiguration<FixedAssetDeprecationMethodFile>
{
    public void Configure(EntityTypeBuilder<FixedAssetDeprecationMethodFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_FixedAssetDeprecationMethod_Files_1");
