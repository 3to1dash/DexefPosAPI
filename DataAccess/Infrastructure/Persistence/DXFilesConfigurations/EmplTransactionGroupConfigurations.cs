...
public class EmplTransactionGroupConfigurations : IEntityTypeConfiguration<EmplTransactionGroup>
{
    public void Configure(EntityTypeBuilder<EmplTransactionGroup> builder)
    {
        builder.ToTable("Empl_Transaction_Groups");
