...
public class FixedAssetDailyDeprecateFileConfigurations : IEntityTypeConfiguration<FixedAssetDailyDeprecateFile>
{
    public void Configure(EntityTypeBuilder<FixedAssetDailyDeprecateFile> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_FixedAsset_DailyDeprecate_Files_1");
