...
public class FixedAssetAreaGroupConfigurations : IEntityTypeConfiguration<FixedAssetAreaGroup>
{
    public void Configure(EntityTypeBuilder<FixedAssetAreaGroup> builder)
    {
        builder.ToTable("FixedAssetArea_Groups");
