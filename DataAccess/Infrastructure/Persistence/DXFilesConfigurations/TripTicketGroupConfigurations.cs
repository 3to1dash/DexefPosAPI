...
public class TripTicketGroupConfigurations : IEntityTypeConfiguration<TripTicketGroup>
{
    public void Configure(EntityTypeBuilder<TripTicketGroup> builder)
    {
        builder.ToTable("TripTicket_Groups");
