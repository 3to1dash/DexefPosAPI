...
public class WorkExtradayGroupConfigurations : IEntityTypeConfiguration<WorkExtradayGroup>
{
    public void Configure(EntityTypeBuilder<WorkExtradayGroup> builder)
    {
        builder.ToTable("work_extraday_Groups");
